package br.com.devinhouse.projeto4.dto;

import java.io.Serializable;

public class ProcessoDTO implements Serializable {
	private static final long serialVersionUID = 1838934594260766205L;
	...
	private static Integer countProcessoId = 40;
	...
	public static Integer getCountProcessoId() {
		ProcessoDTO.countProcessoId++;
		return countProcessoId;
	}
